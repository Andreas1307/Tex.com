let mainOver1000 = document.querySelector('.main-over1000');

let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard6 = document.querySelector('.listCard6');
...
let mainListOver1000 = [];


function initApp2() {
    productContentOver1000.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardOver1000(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainOver1000.appendChild(newDiv)
    });
}
initApp2()
function addToCardOver1000(key){
    if(mainListOver1000[key] == null) {
        mainListOver1000[key] = productContentOver1000[key];
        mainListOver1000[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    ...
    let count = 0;
    let totalPrice = 0;
    mainListOver1000.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity36(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard6.appendChild(newDiv);
        }
    });
    quantity.innerText = count;
}

function changeQuantity36(key, quantity) {
    if (quantity == 0) {
        delete mainListOver1000[key];
    } else {
        mainListOver1000[key].quantity = quantity;
        mainListOver1000[key].price = quantity * products[key].price;
    }
    reloadCard()
}
