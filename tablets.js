let mainTablets1 = document.querySelector('.main-tablet1');
let mainTablets2 = document.querySelector('.main-tablet2');
let mainTablets3 = document.querySelector('.main-tablet3');



let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard10 = document.querySelector('.listCard10');
...
let mainTab4 = [];
function initApp2() {
    productTablets1.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTab(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTablets1.appendChild(newDiv)
    });

    productTablets2.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTab2(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTablets2.appendChild(newDiv)
    });

    productTablets3.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTab3(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTablets3.appendChild(newDiv)
    });

}
initApp2()
function addToCardTab(key){
    if(mainTab1[key] == null) {
        mainTab1[key] = productTablets1[key];
        mainTab1[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardTab2(key){
    if(mainTab2[key] == null) {
        mainTab2[key] = productTablets2[key];
        mainTab2[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardTab3(key){
    if(mainTab3[key] == null) {
        mainTab3[key] = productTablets3[key];
        mainTab3[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    listCard10.innerHTML = '';
    let count = 0;
    let totalPrice = 0;

    mainTab1.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity50(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard10.appendChild(newDiv);
        }
    });
    mainTab2.forEach((value, key) => {
        totalPrice = totalPrice + value.price;
        count = count + value.quantity;
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity51(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard10.appendChild(newDiv);
        }
    ...
    mainTab3.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity52(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard10.appendChild(newDiv);
        }
...
function changeQuantity50(key, quantity) {
    if (quantity == 0) {
        delete mainTab1[key];
    } else {
        mainTab1[key].quantity = quantity;
        mainTab1[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity51(key, quantity) {
    if (quantity == 0) {
        delete mainTab2[key];
    } else {
        mainTab2[key].quantity = quantity;
        mainTab2[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity52(key, quantity) {
    if (quantity == 0) {
        delete mainTab3[key];
    } else {
        mainTab3[key].quantity = quantity;
        mainTab3[key].price = quantity * products[key].price;
    }
    reloadCard()
}
