let mainLaptop1 = document.querySelector('.main-plaptop1');
let mainBetween200 = document.querySelector('.main-pbetween200');
let mainGamingAccessories1 = document.querySelector('.main-pGamingAccessories1');
let mainTablets2 = document.querySelector('.main-ptablet2');
let main8gb = document.querySelector('.main-p8gb');
