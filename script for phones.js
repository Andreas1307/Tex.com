let mainProducts1 = document.querySelector('.main-products1');
let mainProducts2 = document.querySelector('.main-products2');
let mainProducts3 = document.querySelector('.main-products3');
let mainProducts4 = document.querySelector('.main-products4');
...
let mainPro4 = [];
function initApp2() {
    productContent1.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardMain2(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainProducts1.appendChild(newDiv)
    });

    productContent2.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
        ...
        `
        mainProducts2.appendChild(newDiv)
    });

    productContent3.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardMain3(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainProducts3.appendChild(newDiv)
    });

    productContent4.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardMain4(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainProducts4.appendChild(newDiv)
    });
}
initApp2()
function addToCardMain(key){
    if(mainPro1[key] == null) {
        mainPro1[key] = productContent1[key];
        mainPro1[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardMain2(key){
    if(mainPro2[key] == null) {
        mainPro2[key] = productContent2[key];
        mainPro2[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardMain3(key){
    if(mainPro3[key] == null) {
        mainPro3[key] = productContent3[key];
        mainPro3[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardMain4(key){
    if(mainPro4[key] == null) {
        mainPro4[key] = productContent4[key];
        mainPro4[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    ...
    mainPro1.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity39(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard2.appendChild(newDiv);
        }
    });
    mainPro2.forEach((value, key) => {
        totalPrice = totalPrice + value.price;
        count = count + value.quantity;
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity40(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard2.appendChild(newDiv);
        }
    ...
    mainPro3.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity41(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard2.appendChild(newDiv);
        }
    ...
    mainPro4.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity42(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard2.appendChild(newDiv);
        }
...
function changeQuantity39(key, quantity) {
    if (quantity == 0) {
        delete mainPro1[key];
    } else {
        mainPro1[key].quantity = quantity;
        mainPro1[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity40(key, quantity) {
    if (quantity == 0) {
        delete mainPro2[key];
    } else {
        mainPro2[key].quantity = quantity;
        mainPro2[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity41(key, quantity) {
    if (quantity == 0) {
        delete mainPro3[key];
    } else {
        mainPro3[key].quantity = quantity;
        mainPro3[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity42(key, quantity) {
    if (quantity == 0) {
        delete mainPro4[key];
    } else {
        mainPro4[key].quantity = quantity;
        mainPro4[key].price = quantity * products[key].price;
    }
    reloadCard()
}
