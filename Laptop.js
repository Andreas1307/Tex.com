let mainLaptop1 = document.querySelector('.main-laptop1');
let mainLaptop2 = document.querySelector('.main-laptop2');
let mainLaptop3 = document.querySelector('.main-laptop3');



let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard16 = document.querySelector('.listCard16');
...
let mainLap4 = [];
function initApp2() {
    productLaptops1.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardLap(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainLaptop1.appendChild(newDiv)
    });

    productLaptops2.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardLap2(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainLaptop2.appendChild(newDiv)
    });

    productLaptops3.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardLap3(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainLaptop3.appendChild(newDiv)
    });

}
initApp2()
function addToCardLap(key){
    if(mainLap1[key] == null) {
        mainLap1[key] = productLaptops1[key];
        mainLap1[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardLap2(key){
    if(mainLap2[key] == null) {
        mainLap2[key] = productLaptops2[key];
        mainLap2[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardLap3(key){
    if(mainLap3[key] == null) {
        mainLap3[key] = productLaptops3[key];
        mainLap3[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    listCard16.innerHTML = '';
    let count = 0;
    let totalPrice = 0;

    mainLap1.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity25(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard16.appendChild(newDiv);
        }
    });
    mainLap2.forEach((value, key) => {
        totalPrice = totalPrice + value.price;
        count = count + value.quantity;
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity26(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard16.appendChild(newDiv);
        }
    ...
    mainLap3.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity27(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard16.appendChild(newDiv);
        }
...
function changeQuantity25(key, quantity) {
    if (quantity == 0) {
        delete mainLap1[key];
    } else {
        mainLap1[key].quantity = quantity;
        mainLap1[key].price = quantity * products[key].price;
    }
    reloadCard()
}

function changeQuantity26(key, quantity) {
    if (quantity == 0) {
        delete mainLap2[key];
    } else {
        mainLap2[key].quantity = quantity;
        mainLap2[key].price = quantity * products[key].price;
    }
    reloadCard()
}

function changeQuantity27(key, quantity) {
    if (quantity == 0) {
        delete mainLap3[key];
    } else {
        mainLap3[key].quantity = quantity;
        mainLap3[key].price = quantity * products[key].price;
    }
    reloadCard()
}
