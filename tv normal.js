let mainTvNormal = document.querySelector('.main-tvNormal');



let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard32 = document.querySelector('.listCard32');
...
let mainListTvNormal = [];

function initApp2() {
    productTvNormal.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTvNormal(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTvNormal.appendChild(newDiv)
    });

   
}
initApp2()
function addToCardTvNormal(key){
    if(mainListTvNormal[key] == null) {
        mainListTvNormal[key] = productTvNormal[key];
        mainListTvNormal[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    listCard32.innerHTML = '';
    let count = 0;
    let totalPrice = 0;

    mainListTvNormal.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity54(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard32.appendChild(newDiv);
        }
    });
...
function changeQuantity54(key, quantity) {
    if (quantity == 0) {
        delete mainListTvNormal[key];
    } else {
        mainListTvNormal[key].quantity = quantity;
        mainListTvNormal[key].price = quantity * products[key].price;
    }
    reloadCard()
}
