let mainGaming1 = document.querySelector('.main-Gaming1');
let mainGaming2 = document.querySelector('.main-Gaming2');
let mainGaming3 = document.querySelector('.main-Gaming3');



let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard22 = document.querySelector('.listCard22');
...
let mainGam3 = [];
function initApp2() {
    productGaming1.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardGam(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainGaming1.appendChild(newDiv)
    });

    productGaming2.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardGam2(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainGaming2.appendChild(newDiv)
    });

    productGaming3.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardGam3(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainGaming3.appendChild(newDiv)
    });

}
initApp2()
function addToCardGam(key){
    if(mainGam1[key] == null) {
        mainGam1[key] = productGaming1[key];
        mainGam1[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardGam2(key){
    if(mainGam2[key] == null) {
        mainGam2[key] = productGaming2[key];
        mainGam2[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardGam3(key){
    if(mainGam3[key] == null) {
        mainGam3[key] = productGaming3[key];
        mainGam3[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    listCard22.innerHTML = '';
    let count = 0;
    let totalPrice = 0;

    mainGam1.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity16(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard22.appendChild(newDiv);
        }
    });
    mainGam2.forEach((value, key) => {
        totalPrice = totalPrice + value.price;
        count = count + value.quantity;
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity17(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard22.appendChild(newDiv);
        }
    ...
    mainGam3.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>${value.price.toLocaleString()}</div>  
            <div>
            <button class="changeQuantity" onclick="changeQuantity18(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard22.appendChild(newDiv);
        }
...
function changeQuantity16(key, quantity) {
    if (quantity == 0) {
        delete mainGam1[key];
    } else {
        mainGam1[key].quantity = quantity;
        mainGam1[key].price = quantity * products[key].price;
    }
    reloadCard()
}

function changeQuantity17(key, quantity) {
    if (quantity == 0) {
        delete mainGam2[key];
    } else {
        mainGam2[key].quantity = quantity;
        mainGam2[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity18(key, quantity) {
    if (quantity == 0) {
        delete mainGam3[key];
    } else {
        mainGam3[key].quantity = quantity;
        mainGam3[key].price = quantity * products[key].price;
    }
    reloadCard()
}
