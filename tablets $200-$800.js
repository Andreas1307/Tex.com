let mainTabletsBetween1 = document.querySelector('.main-tabletBetween1');
let mainTabletsBetween2 = document.querySelector('.main-tabletBetween2');



let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard12 = document.querySelector('.listCard12');
...
function initApp2() {
    productTabletsBetween1.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTabBetween1(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTabletsBetween1.appendChild(newDiv)
    });
    productTabletsBetween2.forEach((value, key) => {
        let newDiv = document.createElement('div');
        newDiv.classList.add('item')
        newDiv.innerHTML = `
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardTabBetween2(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainTabletsBetween2.appendChild(newDiv)
    });


}
initApp2()
function addToCardTabBetween1(key){
    if(mainTabBetween1[key] == null) {
        mainTabBetween1[key] = productTabletsBetween1[key];
        mainTabBetween1[key].quantity = 1;
 }    
 reloadCard();
}
function addToCardTabBetween2(key){
    if(mainTabBetween2[key] == null) {
        mainTabBetween2[key] = productTabletsBetween2[key];
        mainTabBetween2[key].quantity = 1;
 }    
 reloadCard();
}

function reloadCard() {
    listCard12.innerHTML = '';
    let count = 0;
    let totalPrice = 0;

    mainTabBetween1.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity43(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard12.appendChild(newDiv);
        }
    });

    mainTabBetween2.forEach((value, key) => {
        totalPrice = totalPrice + value.price;
        count = count + value.quantity;
...
function changeQuantity43(key, quantity) {
    if (quantity == 0) {
        delete mainTabBetween1[key];
    } else {
        mainTabBetween1[key].quantity = quantity;
        mainTabBetween1[key].price = quantity * products[key].price;
    }
    reloadCard()
}
function changeQuantity44(key, quantity) {
    if (quantity == 0) {
        delete mainTabBetween2[key];
    } else {
        mainTabBetween2[key].quantity = quantity;
        mainTabBetween2[key].price = quantity * products[key].price;
    }
    reloadCard()
}
