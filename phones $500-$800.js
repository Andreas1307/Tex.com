let mainBetween58 = document.querySelector('.main-between58');

let openShopping = document.querySelector('.cart');
let closeShopping = document.querySelector('.closeShopping');
let listCard5 = document.querySelector('.listCard5');
...
let mainListBetween58 = [];


function initApp2() {
    productContentBetween58.forEach((value, key) => {
        ...
        <div class="slider-box">
                    ...
                    <div class="slider-text">
                        ...
                        <button onclick="addToCardBetween58(${key})">Add To Cart</button>
                    </div>
                </div>
        `
        mainBetween58.appendChild(newDiv)
    });
}
initApp2()
function addToCardBetween58(key){
    if(mainListBetween58[key] == null) {
        mainListBetween58[key] = productContentBetween58[key];
        mainListBetween58[key].quantity = 1;
 }    
 reloadCard();
}
...
function reloadCard() {
    ...
    let count = 0;
    let totalPrice = 0;
    mainListBetween58.forEach((value, key) => {
        ...
        if(value != null) {
            ...
            <div>
            <button class="changeQuantity" onclick="changeQuantity30(${key}, ${value.quantity - 1})">Remove</button>
            </div>
            `
            listCard5.appendChild(newDiv);
        }
    });
    quantity.innerText = count;
}

function changeQuantity30(key, quantity) {
    if (quantity == 0) {
        delete mainListBetween58[key];
    } else {
        mainListBetween58[key].quantity = quantity;
        mainListBetween58[key].price = quantity * products[key].price;
    }
    reloadCard()
}
